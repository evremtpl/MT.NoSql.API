...
namespace MT.NoSql.API.Controllers
{
    ...
    [ApiController]
    public class TasksRedisController : ControllerBase
    {
        private readonly IRepositoryFactory _repositoryFactory;
        private readonly TaskRedisRepository _taskRepository;

        public TasksRedisController(IRepositoryFactory repositoryFactory)
        {
            _repositoryFactory = repositoryFactory;
            _taskRepository = (TaskRedisRepository)_repositoryFactory.CreateTaskRepository(DataStore.Redis).Result;
        }
