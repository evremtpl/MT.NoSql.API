...
namespace MT.NoSql.API.Controllers
{
    ...
    [ApiController]
    public class CategoriesRedisController : ControllerBase
    {
        private readonly CategoryRedisRepository _categoryRepository;
        private readonly IRepositoryFactory _repositoryFactory;

        public CategoriesRedisController(IRepositoryFactory repositoryFactory)
        {
            _repositoryFactory = repositoryFactory;

            _categoryRepository = (CategoryRedisRepository)_repositoryFactory.CreateCategoryRepository(DataStore.Redis).Result;
        }
