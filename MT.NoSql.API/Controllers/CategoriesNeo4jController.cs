...
namespace MT.NoSql.API.Controllers
{
    ...
    [ApiController]
    public class CategoriesNeo4jController : ControllerBase
    {

        private readonly CategoryNeo4jRepository _categoryRepository;
        private readonly IRepositoryFactory _repositoryFactory;

        public CategoriesNeo4jController(IRepositoryFactory repositoryFactory)
        {
            _repositoryFactory = repositoryFactory;

            _categoryRepository = (CategoryNeo4jRepository)_repositoryFactory.CreateCategoryRepository(DataStore.Neo4jCategory).Result;
        }
